...
func (s *Server) HandleImportChannelsCSV(c *gin.Context) {
	...
	for {
		...
		if modelsRaw == "" && isOAuthPreset {
			switch preset {
			case "kiro":
				modelsRaw = "claude-opus-4-8,claude-opus-4-6,claude-sonnet-4-6,claude-opus-4-5-20251101,claude-sonnet-4-5-20250929,claude-haiku-4-5-20251001,claude-opus-4-1-20250805,claude-sonnet-4-20250514,claude-opus-4-20250514"
			case "codex":
				modelsRaw = "gpt-5.5,gpt-5.4,gpt-5.4-mini,gpt-5.3-codex,gpt-5.3-codex-spark,gpt-5.2-codex,gpt-5.2,gpt-5.1-codex,gpt-5.1-codex-max,gpt-5.1-codex-mini,gpt-5,gpt-5.1"
			case "gemini":
