...
func TestHandleSuccessResponse_ExtractsUsageFromJSON(t *testing.T) {
	...
	res, _, err := s.handleSuccessResponse(reqCtx, resp, 0, resp.Header.Clone(), rec, "anthropic", &testChannelID, testAPIKey, "/v1/chat/completions", "https://test.example.com/v1/chat/completions", false)
	if err != nil {
